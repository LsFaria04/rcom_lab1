...
void state_machine_data_frame(unsigned char *byte, bool *isRej, bool *isDisc,bool *connectionLost){
    switch(state_frame){
        case START:
            if(*byte == FLAG){
...
int llread(unsigned char *packet)
{
    ...
    while(true){
            ...
            state_machine_data_frame(received_frame, &isRej, &isDisc,&connectionLost);
